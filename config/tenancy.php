...
return [
    ...
    'id_generator' => null, // We'll use custom IDs (clinic_xxx)
     ...
     */
    'bootstrappers' => [
        App\Tenancy\DatabaseTenancyBootstrapper::class, // Custom for Hostinger one-user-per-db
    ...
    'database' => [
        ...
        'managers' => [
            ...
            // Use custom Hostinger manager that handles one-user-per-database limitation
            'mysql' => \App\Tenancy\HostingerDatabaseManager::class,
